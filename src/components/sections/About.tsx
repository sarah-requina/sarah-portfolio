...
const industries = [
  { name: "Events & Exhibitions", years: "5 yrs", color: "bg-slate/10 text-slate border-slate/20" },
  { name: "Healthcare Operations", years: "2 yrs", color: "bg-gold/10 text-gold-dark border-gold/20" },
  { name: "Diplomatic Services", years: "2 yrs", color: "bg-sage/10 text-sage border-sage/20" },
...
const values = [
  ...
  },
  {
    ...
    detail: "Seven years in the UAE and diplomatic service have trained me to read any room.",
  },
];
      ...
      <div className="page-container">
        <div ref={ref} className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5">
            ...
            >
              ...
              <h2 className="display-headline text-display-xl mb-8 text-balance">
                A project manager shaped by the{" "}
                <em className="text-gold not-italic">UAE's most demanding stages.</em>
              </h2>
            </motion.div>
          ...
          <div className="lg:col-span-7 lg:pt-16">
            ...
            >
              <p>
                My career has been built across environments where failure isn't an option — Formula 1
                race weekends, live theme park activations, diplomatic consular operations, and healthcare
                facility launches under regulatory scrutiny.
              </p>
              <p>
                What ties these worlds together is the fundamental discipline of project management: knowing
                what needs to happen, in what order, by whom, and how to adapt when reality diverges from
