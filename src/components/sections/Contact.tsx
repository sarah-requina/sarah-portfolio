            ...
            >
              {submitted ? (
                <motion.div
                  ...
                  className="flex flex-col items-center justify-center text-center py-16 px-8 bg-white/5 backdrop-blur-sm rounded-3xl border border-white/10"
                >
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 bg-white/8 border border-white/15 rounded-xl text-white placeholder:text-white/30 font-body text-sm focus:outline-none focus:border-gold/50 focus:bg-white/10 transition-all duration-200"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="e.g. Senior PM, Real Estate Developer"
                        className="w-full px-4 py-3 bg-white/8 border border-white/15 rounded-xl text-white placeholder:text-white/30 font-body text-sm focus:outline-none focus:border-gold/50 focus:bg-white/10 transition-all duration-200"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={4}
                        className="w-full px-4 py-3 bg-white/8 border border-white/15 rounded-xl text-white placeholder:text-white/30 font-body text-sm focus:outline-none focus:border-gold/50 focus:bg-white/10 transition-all duration-200 resize-none"
                      />
                    </div>
